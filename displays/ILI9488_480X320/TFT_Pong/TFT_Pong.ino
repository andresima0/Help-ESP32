...
int16_t h = 320; // Updated height
int16_t w = 480; // Updated width

int dly = 5;

int16_t paddle_h = 40; // Scaled for larger screen
int16_t paddle_w = 6;  // Scaled for larger screen
...
int16_t ball_w = 8; // Scaled for larger screen
int16_t ball_h = 8; // Scaled for larger screen

int16_t dashline_h = 6; // Scaled for larger screen
int16_t dashline_w = 4; // Scaled for larger screen
...
void ball() {
  ...
  tft.drawRect(oldball_x, oldball_y, ball_w, ball_h, BLACK);
